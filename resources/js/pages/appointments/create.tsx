...
export default function Create({
    ...
    useEffect(() => {
        ...
        if (service) {
            setData(
                'end_time',
                addMinutes(data.start_time, service.duration_minutes),
            );
        }
                            ...
                            <CardContent className="flex flex-col gap-4">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Walk-ins are always registered for
                                        today.
                                    </p>
                                </div>
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,340px)_1fr]">
                    <div className="lg:sticky lg:top-6 lg:self-start">
                        <AppointmentCalendar
                            ...
                            selectedTime={data.start_time || undefined}
                            onDateSelect={(d) => setData('appointment_date', d)}
                            onTimeSelect={(t) => setData('start_time', t)}
                        />
                    </div>
                        ...
                        <Card>
                            ...
                            <CardContent className="flex flex-col gap-4">
                                {!data.appointment_date && (
                                    <p className="text-xs text-muted-foreground">
                                        Select a date and time slot from the
                                        calendar.
                                    </p>
                                )}
